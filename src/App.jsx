  ...
  return (
    <div className=' font-sans text-center bg-gray-300 min-h-screen flex flex-col justify-between'>
      <header className='w-screen bg-white flex items-center justify-between '>
        ...
        <a href="https://valueglance.com/" target="_blank" rel="noopener noreferrer">
              <img
              src={logo}
              alt="Logo"
              className="w-40 h-24 mx-auto sm:w-64 sm:h-32"
              />
        </a>
        </div>
      </header>
      <h1 className='mb-4 text-3xl font-extrabold text-gray-900 dark:text-black md:text-5xl lg:text-6xl'><span className='underline text-transparent bg-clip-text bg-gradient-to-r to-cyan-600 from-cyan-900 '>APPL</span> Financial Data</h1>
